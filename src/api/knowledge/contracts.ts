...
export const KNOWLEDGE_SEARCH_MAX_LENGTH = 80;
export const KNOWLEDGE_LIST_MAX_LIMIT = 200;
...
export type KnowledgeApi = {
  listArticles(input: KnowledgeListInput): Promise<PublishedKnowledgeArticleList>;
  getArticle(input: {
    slug: string;
    locale: KnowledgeLocale;
