...
export const createSocialNotificationScreenStyles = (colors: typeof Colors.light, glass: LiquidGlassPalette) =>
  StyleSheet.create({
    ...
    message: { color: colors.textPrimary, fontSize: Typography.callout.fontSize, lineHeight: Typography.callout.lineHeight },
    notificationCard: { alignSelf: 'center', backgroundColor: glass.cardFill, borderColor: glass.cardBorder, borderWidth: StyleSheet.hairlineWidth, gap: Spacing.one, maxWidth: MaxContentWidth, minHeight: 68, paddingHorizontal: Spacing.three, paddingVertical: Spacing.two, width: '100%' },
    ...
    notificationPressed: { backgroundColor: glass.controlPressedFill },
